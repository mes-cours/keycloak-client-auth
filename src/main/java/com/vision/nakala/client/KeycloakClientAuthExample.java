...
public class KeycloakClientAuthExample {
	...
	public static void main(String[] args) {
		...
		KeycloakClientFacade facade = new KeycloakClientFacade("http://localhost:8380/auth", "MULE", "composant-agent-service", "eef1ee62-ac72-4be1-bfa5-0be3772f071d");
		...
		AccessToken accessToken = facade.getAccessToken("khalifa", "passer");
		System.out.println(accessToken.getSubject());
		System.out.println(accessToken.getAuthorization());
	}
